...
**Updated Naming Convention:** All references to "snacks" have been changed to "menu" items for better clarity. API endpoints use `/api/menu` instead of `/api/menuitems`.
